    ...
    render() {
        ...
        return (
            <li className="product-item">
                ...
                <p style={{ alignSelf: 'center', marginTop: 10, color: '#BF081F', fontWeight: 'bold', margin: 0 }}>Giá: {item.price} VNĐ</p>
                <button
                    style={{ marginTop: 10, alignSelf: 'center', backgroundColor: '#46A049', padding: 8 }}
                    onClick={() => onAdd(item)}>
                    <p style={{ color: 'white', fontWeight: 'bold', margin: 0 }}>Thêm vào giỏ hàng</p>
                </button>
            </li>
        );
    }
